...
export const download_pdf = ({ nurseries, columns, title }: any): any => {
    ...
    const handleClick = (): void => {
      ...
      // Verifica la ruta y el tipo de imagen al agregarla
      ...
      const gato_text_width = doc.getStringUnitWidth(gato_text) * 16;
      const gato_x = text_x + gato_text_width / 2 + 8;
      const gato_y = text_y;
      ...
      const start_y = img_y + img_height - 25;
      ...
      const file_name = `Reporte_Bliblioteca_Cofrem:${file_id}.pdf`;
...
export const download_pdf_dos = ({ nurseries, columns, title }: any):any=> {
