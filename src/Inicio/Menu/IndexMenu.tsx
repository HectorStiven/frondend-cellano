...
const menuDia = {
  ...
  plato_principal: {
    ...
    descripcion: "Delicioso arroz con pollo al estilo casero",
    imagen:
      "https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif",
  },
  acompanamiento: {
    nombre: "Ensalada Fresca",
    descripcion: "Mezcla de verduras frescas con aderezo",
    imagen:
      "https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif",
  },
  bebida: {
  ...
  postre: {
    nombre: "Gelatina",
    descripcion: "Gelatina de sabores variados",
    imagen:
      "https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif",
  },
};
  ...
  return (
    <Box sx={{ padding: 4, minHeight: "100vh" }}>
      ...
      <Grid container spacing={4} justifyContent="center">
        {[
          menuDia.plato_principal,
          menuDia.acompanamiento,
          menuDia.bebida,
          menuDia.postre,
        ].map((item, index) => (
